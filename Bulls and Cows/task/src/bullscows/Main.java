...
public class Main {
    public static void main(String[] args) {
        ...
        if (cLen <= range) {
            ...
            System.out.println("The secret is prepared:" + asterisks(cLen) + ran(range));
            int turn = 1;
            while (true) {
    ...
    */
    ...
    /**
    @param x
    The number of characters the code contains
    @returns
    A string containing only asterisks equal to the number passed as x
     */

    public static String asterisks(int x) {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < x; i++){
            sb.append("*");
        }
